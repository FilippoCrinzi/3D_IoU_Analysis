...
def trade_off_align(path_obj, path_point_cloud):
    ...
    for num_points in num_point:
        ...
        iou_value = iou.align_iou_for_frame(path_obj, path_point_cloud, num_points)
        end_time = time.time()
...
point_cloud_time1 = ('/Users/filippocrinzi/Documents/UNIFI/Tesi/3DIoUAnalysis/data/point_clouds'
                     '/PointCloud_traj_argo_50_AV_MercedesGLS580_scans50_s7_h2_5_10_v3_vehicle_time_1_downsampled_gridAverage_step0.60.csv')
